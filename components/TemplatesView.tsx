...
import { Upload, Plus, Search, FileCode, Check, AlertCircle, Download, X } from 'lucide-react';
...
const TemplatesView: React.FC = () => {
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    alert("Simulation: File received. In production, this would parse the XML/YAML.");
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg shadow-lg shadow-primary-600/20 transition-colors">
           ...
           <div className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-xl shadow-2xl flex flex-col">
              ...
              <div className="p-6">
                 ...
                 >
                    ...
                    <button className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg border border-slate-700 text-sm">
                       Selecionar Arquivo
                    </button>
                 </div>
